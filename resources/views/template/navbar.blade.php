<header id="siteHeader" class="{{ request()->routeIs('landing') ? 'bg-transparent' : 'bg-white shadow-sm' }} sticky top-0 z-50 transition-colors duration-300">
    <nav class="container mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div class="hidden md:flex space-x-6">
            <a href="{{ route('landing') }}" class="{{ request()->routeIs('landing') ? 'text-[#002837] font-medium' : 'text-gray-600' }} hover:text-[#002837]">Home</a>
            <a href="{{ route('layanan') }}" class="{{ request()->routeIs('layanan') ? 'text-[#002837] font-medium' : 'text-gray-600' }} hover:text-[#002837]">Services</a>
