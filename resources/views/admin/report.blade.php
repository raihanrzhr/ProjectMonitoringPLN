                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn-action edit btn-edit-report" 
                                data-bs-toggle="modal" 
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" name="new_images[]" id="newImages" multiple accept="image/jpeg,image/jpg,image/png" class="form-control">
